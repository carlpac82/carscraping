#!/usr/bin/env python3
"""
Script para importar dados de brokers CM-26 com mapeamento completo
"""
import os
import psycopg2
import pandas as pd
...
def import_cm26_brokers():
    """Importar dados de brokers dos ficheiros CM-26"""
    print("=" * 80)
    print("IMPORTAÇÃO DE DADOS DE BROKERS CM-26")
    print("=" * 80)
    ...
    try:
        ...
        # Mapeamento EXATO de brokers (baseado na análise anterior)
        broker_mapping = {
            'ABBYCAR-POA': 245,
            'ABBYCAR-PREPAID': 236,
            'AQUAMAR': 19,
