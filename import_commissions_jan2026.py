#!/usr/bin/env python3
"""
Script para importar comissões de janeiro 2026 do ficheiro CM-01-2026.xlsx
"""
import os
import pandas as pd
import psycopg2
...
def import_commissions():
    ...
    try:
        ...
        # Ler ficheiro Excel
        print("\n📄 Lendo ficheiro CM-01-2026.xlsx...")
        ...
        for name in commissioners.keys():
            print(f"  - {name}")
        ...
        for idx, row in df.iterrows():
            ...
            if pd.notna(row['Data Entrega']) and current_hotel:
                ...
                try:
                    ...
                    print(f"  ✅ {pickup_date.strftime('%d/%m/%Y')} - {days} dias - €{commission_amount:.0f}")
                    imported_count += 1
